  ...
  <div>
    <NuxtLayout name="dashboard">
      ...
      <div class="flex justify-between items-center mb-6">
        ...
        <NuxtLink to="/empresa/dashboard/gerenciar-excursoes" class="btn btn-outline flex items-center">
          ...
          <div v-if="currentStep === 7">
            ...
            <div class="space-y-6">
              ...
              <div v-if="Object.keys(allStepErrors).length > 0" class="bg-red-50 p-4 rounded-lg border border-red-200">
                ...
                <p class="mt-2 text-red-700">Por favor, preencha todos os campos obrigatórios antes de publicar a excursão.</p>
              </div>
            </div>
          </div>
        </div>
...
const publishExcursion = async () => {
  ...
  if (!validateAllSteps()) {
    alert('Por favor, preencha todos os campos obrigatórios antes de publicar a excursão.');
    return;
  }
