...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"Viajae é um marketplace de excursões com hospedagem, onde empresas de turismo podem cadastrar viagens de vários dias, e usuários podem reservar suas vagas com facilidade."}],"link":[{"rel":"icon","type":"image/svg+xml","href":"/favicon.svg"}],"style":[],"script":[],"noscript":[],"title":"Viajae - Marketplace de Excursões com Hospedagem"};
